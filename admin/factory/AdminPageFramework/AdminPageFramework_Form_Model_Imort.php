 ...
 */
abstract class mhelpdeskAdminPageFramework_Form_Model_Import extends mhelpdeskAdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new mhelpdeskAdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
