 ...
 */
abstract class mhelpdeskAdminPageFramework_Form_Model_Export extends mhelpdeskAdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new mhelpdeskAdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
