 ...
 */
class mhelpdeskAdminPageFramework_ExportOptions extends mhelpdeskAdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo mhelpdeskAdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
