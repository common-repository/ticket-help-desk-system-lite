 ...
 */
class mhelpdeskAdminPageFramework_Property_Page extends mhelpdeskAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['amhelpdeskAdminPageFramework']['aPageClasses'] = isset($GLOBALS['amhelpdeskAdminPageFramework']['aPageClasses']) && is_array($GLOBALS['amhelpdeskAdminPageFramework']['aPageClasses']) ? $GLOBALS['amhelpdeskAdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['amhelpdeskAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
