 ...
 */
abstract class mhelpdeskAdminPageFramework_Page_View_MetaBox extends mhelpdeskAdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['amhelpdeskAdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['amhelpdeskAdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['amhelpdeskAdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['amhelpdeskAdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['amhelpdeskAdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['amhelpdeskAdminPageFramework']['bAddedMetaBoxScript'] = true;
