 ...
 */
abstract class mhelpdeskAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['amhelpdeskAdminPageFramework'] = isset($GLOBALS['amhelpdeskAdminPageFramework']) && is_array($GLOBALS['amhelpdeskAdminPageFramework']) ? $GLOBALS['amhelpdeskAdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => mhelpdeskAdminPageFramework_Registry::NAME, 'sURI' => mhelpdeskAdminPageFramework_Registry::URI, 'sScriptName' => mhelpdeskAdminPageFramework_Registry::NAME, 'sLibraryName' => mhelpdeskAdminPageFramework_Registry::NAME, 'sLibraryURI' => mhelpdeskAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => mhelpdeskAdminPageFramework_Registry::getVersion(), 'sDescription' => mhelpdeskAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => mhelpdeskAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => mhelpdeskAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => mhelpdeskAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => mhelpdeskAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : mhelpdeskAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
