 ...
 */
abstract class mhelpdeskAdminPageFramework_FormField_Base extends mhelpdeskAdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new mhelpdeskAdminPageFramework_Script_Widget;
        ...
        new mhelpdeskAdminPageFramework_Script_Utility;
        new mhelpdeskAdminPageFramework_Script_OptionStorage;
        new mhelpdeskAdminPageFramework_Script_AttributeUpdator;
        new mhelpdeskAdminPageFramework_Script_RepeatableField($this->oMsg);
        new mhelpdeskAdminPageFramework_Script_Sortable;
        new mhelpdeskAdminPageFramework_Script_RegisterCallback;
    }
