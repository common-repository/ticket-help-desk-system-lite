 ...
 */
class mhelpdeskAdminPageFramework_FieldType_system extends mhelpdeskAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getPHPInfo($bGenerateInfo = true) {
        ...
        $_oErrorReporting = new mhelpdeskAdminPageFramework_ErrorReporting;
