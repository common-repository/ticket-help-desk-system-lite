 ...
 */
class mhelpdeskAdminPageFramework_FieldType_radio extends mhelpdeskAdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new mhelpdeskAdminPageFramework_Input_radio($aField['attributes']);
