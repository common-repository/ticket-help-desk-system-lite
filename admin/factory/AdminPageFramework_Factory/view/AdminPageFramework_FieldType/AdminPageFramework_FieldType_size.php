 ...
 */
class mhelpdeskAdminPageFramework_FieldType_size extends mhelpdeskAdminPageFramework_FieldType_select {
...
CSSRULES;
    ...
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
        ...
        $_oUnitInput = new mhelpdeskAdminPageFramework_Input_select($_aUnitAttributes + array('select' => $_aUnitAttributes));
