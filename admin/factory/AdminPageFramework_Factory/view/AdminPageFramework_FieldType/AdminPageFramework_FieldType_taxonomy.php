 ...
 */
class mhelpdeskAdminPageFramework_FieldType_taxonomy extends mhelpdeskAdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new mhelpdeskAdminPageFramework_Script_CheckboxSelector;
    }
