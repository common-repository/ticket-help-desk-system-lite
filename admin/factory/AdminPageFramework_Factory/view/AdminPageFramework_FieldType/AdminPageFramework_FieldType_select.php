 ...
 */
class mhelpdeskAdminPageFramework_FieldType_select extends mhelpdeskAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new mhelpdeskAdminPageFramework_Input_select($aField['attributes']);
