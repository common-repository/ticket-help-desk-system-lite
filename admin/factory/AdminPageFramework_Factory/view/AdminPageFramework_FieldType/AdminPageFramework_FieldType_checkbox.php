 ...
 */
class mhelpdeskAdminPageFramework_FieldType_checkbox extends mhelpdeskAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new mhelpdeskAdminPageFramework_Input_checkbox($aField['attributes']);
