 ...
 */
abstract class mhelpdeskAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $_aFormElementClassNameMap = array('page' => 'mhelpdeskAdminPageFramework_FormElement_Page', 'network_admin_page' => 'mhelpdeskAdminPageFramework_FormElement_Page', 'post_meta_box' => 'mhelpdeskAdminPageFramework_FormElement_Meta', 'page_meta_box' => 'mhelpdeskAdminPageFramework_FormElement', 'post_type' => 'mhelpdeskAdminPageFramework_FormElement', 'taxonomy' => 'mhelpdeskAdminPageFramework_FormElement', 'widget' => 'mhelpdeskAdminPageFramework_FormElement', 'user_meta' => 'mhelpdeskAdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'mhelpdeskAdminPageFramework_Resource_Page', 'network_admin_page' => 'mhelpdeskAdminPageFramework_Resource_Page', 'post_meta_box' => 'mhelpdeskAdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'mhelpdeskAdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'mhelpdeskAdminPageFramework_Resource_PostType', 'taxonomy' => 'mhelpdeskAdminPageFramework_Resource_TaxonomyField', 'widget' => 'mhelpdeskAdminPageFramework_Resource_Widget', 'user_meta' => 'mhelpdeskAdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'mhelpdeskAdminPageFramework_HelpPane_Page', 'network_admin_page' => 'mhelpdeskAdminPageFramework_HelpPane_Page', 'post_meta_box' => 'mhelpdeskAdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'mhelpdeskAdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'mhelpdeskAdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'mhelpdeskAdminPageFramework_HelpPane_Widget', 'user_meta' => 'mhelpdeskAdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'mhelpdeskAdminPageFramework_Link_Page', 'network_admin_page' => 'mhelpdeskAdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'mhelpdeskAdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'mhelpdeskAdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'mhelpdeskAdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'mhelpdeskAdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oUtil() {
        $this->oUtil = new mhelpdeskAdminPageFramework_WPUtility;
        return $this->oUtil;
    }
    public function _replyTpSetAndGetInstance_oDebug() {
        $this->oDebug = new mhelpdeskAdminPageFramework_Debug;
        return $this->oDebug;
    }
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = mhelpdeskAdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
