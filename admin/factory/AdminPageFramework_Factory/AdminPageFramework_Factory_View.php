 ...
 */
abstract class mhelpdeskAdminPageFramework_Factory_View extends mhelpdeskAdminPageFramework_Factory_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new mhelpdeskAdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
