...
<div class="top_hd_menu">
	...
	if(isset($_POST['user-profileBtn'])){ ?>
	<table>
		<tr>
			<th><?php _e('Setting Saved','mhelpdesk');?></th>
         </tr>
     </table>	
	<?php }
...
<form name="formProfileUpdation" action="#" method="post">
	<table>
		...
		<tr id="blockingRow">
			...
			<td>
				<input title="<?php _e('Password must contain at least 6 characters long; including ONE MUST be Uppercase, Lowercase and a Number','mhelpdesk');?>" type="password"
        ...
        <tr><td colspan="2">
            ...
            <input type="submit" value="Update My Profile" name="profileBtn" />
        </td></tr>
	</table>
</form>
